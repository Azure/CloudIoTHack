    ...
    public static class ControlHelper
    {
        public static Grid GenerateMapGrid()
        {
            ...
            {  
                ...
                {
                    var border = new Border() { BorderBrush = new SolidColorBrush(Colors.White), BorderThickness = new Thickness(1.0), HorizontalAlignment = HorizontalAlignment.Stretch, VerticalAlignment = VerticalAlignment.Stretch };
